...
export class BookService {
  ...
  subscribe(userId: string, bookId: string){
    return this.http.post<void>(`${this.apiUrl}/subscribe/${userId}/${bookId}`, {});
  }
  unsubscribe(userId: string, bookId: string){
    return this.http.delete<void>(`${this.apiUrl}/unsubscribe/${userId}/${bookId}`);
  }
